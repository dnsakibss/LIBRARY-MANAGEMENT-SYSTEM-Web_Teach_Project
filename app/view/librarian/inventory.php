...
<div class="d-flex justify-content-between align-items-center mb-4">
  ...
  <h2 class="mb-0">
    <i class="bi bi-archive me-2 text-success"></i>
    Branch Inventory
  </h2>

  <!-- Quick inventory count -->
  <span class="badge bg-success fs-6">
    <?= count($inventory) ?> books
  </span>
            ...
            <?php if (empty($inventory)): ?>
              ...
              <tr>
                <td colspan="6" class="text-muted text-center py-4">
                  No inventory at this branch.
                </td>
              </tr>

            <?php else: foreach ($inventory as $inv):

              // Calculate borrowed and availability percentage
              $borrowed = $inv['total_copies'] - $inv['available_copies'];

              $pct = $inv['total_copies'] > 0
                  ? ($inv['available_copies'] / $inv['total_copies'] * 100)
                  : 0;
            ?>
