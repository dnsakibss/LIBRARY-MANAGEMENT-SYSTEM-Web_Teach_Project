          ...
          <div class="row g-3">
            ...
            <div class="col-md-3">
              ...
              <input type="number" name="published_year" class="form-control"
                     value="<?= e($old['published_year'] ?? date('Y')) ?>"
                     min="1000" max="<?= date('Y') ?>">
            </div>
            ...
            <div class="col-12">
              ...
              <textarea name="description" class="form-control" rows="3"
                        placeholder="Brief description..."><?= e($old['description'] ?? '') ?></textarea>
            </div>

            <!-- Branch-wise inventory setup -->
            <div class="col-12 mt-2">
              <h6 class="fw-bold text-primary border-bottom pb-2">
                <i class="bi bi-building me-2"></i>
                Set Copies Per Branch
                <span class="text-danger">*</span>

                <!-- Small note for clarity -->
                <small class="text-muted fw-normal ms-2">
                  (Set 0 to skip a branch)
                </small>
              </h6>
            </div>
              ...
              <div class="card border shadow-sm h-100">
                ...
                <div class="card-body py-2 px-3">
                  ...
                  <small class="text-muted">
                    Enter number of copies available at this branch
                  </small>
