...
<?php
// Resolve branch name for display in dashboard header
$branchName = '';

if (!empty($_SESSION['branch_id'])) {

    // Load branch details (used only for display purpose)
...
<div class="d-flex justify-content-between align-items-center mb-4">
  ...
  <!-- Dashboard title with branch context -->
  <h2 class="mb-0">
    <i class="bi bi-speedometer2 me-2 text-success"></i>
    Librarian Dashboard<?= $branchName ?>
  </h2>

  <!-- Warning badge if librarian is not assigned to any branch -->
...
<div class="row g-3 mb-4">
  ...
  <?php 
  // Quick summary cards (KPIs for dashboard overview)
  $cards = [
    ['Pending Requests', count($pendingRequests), 'bi-inbox', 'warning'],
    ['Active Loans',     count($activeLoans),     'bi-book-fill', 'success'],
    ['Overdue',          count($overdueLoans),    'bi-exclamation-triangle', 'danger'],
    ['Unpaid Fines',     count($unpaidFines),     'bi-cash', 'info']
  ];
  ...
  <div class="col-md-6">
    <div class="card border-0 shadow-sm">
      ...
      <div class="card-header bg-white fw-semibold text-warning">
        <i class="bi bi-inbox me-2"></i>Pending Borrow Requests
      </div>
      ...
      <div class="card-body p-0">
        ...
        <div class="table-responsive">
          <table class="table table-hover align-middle mb-0 small">
            ...
            <!-- Show only first 5 requests for dashboard preview -->
            <?php foreach(array_slice($pendingRequests,0,5) as $r): ?>
              ...
              <tr>
                ...
                <td>
                  ...
                  <!-- Inline action form (approve/reject) -->
      ...
      <div class="card-footer bg-white">
        <a href="<?= BASE_URL ?>index.php?page=librarian_requests" class="small">View all →</a>
      </div>
    ...
    <div class="card border-0 shadow-sm">
      ...
      <div class="card-body p-0">
        ...
        <?php if(empty($overdueLoans)): ?>
          ...
          <!-- Clean state when nothing is overdue -->
          <p class="text-success text-center py-4">
            <i class="bi bi-check-circle me-2"></i>No overdue loans!
          </p>
        ...
        <div class="table-responsive">
          <table class="table table-hover align-middle mb-0 small">
            ...
            <!-- Show top 5 overdue items for quick glance -->
      ...
      <div class="card-footer bg-white">
        <a href="<?= BASE_URL ?>index.php?page=librarian_loans&filter=overdue" class="small">View all →</a>
      </div>
