...
<!-- Warning if librarian is not assigned to a branch -->
...
<div class="alert alert-warning">
  ...
  Ask an admin to assign you to a branch.
  ...
  <div class="card-body p-0">
    ...
    <?php if (empty($requests)): ?>
      ...
      <div class="text-center py-5 text-muted">
        ...
        <p class="mb-0">
          No pending borrow requests at your branch.
        </p>
    ...
    <div class="table-responsive">
      ...
      <table class="table table-hover align-middle mb-0">
        ...
        // Needed here to check live available copies
        ...
        foreach ($requests as $i => $r):
          ...
          // Remaining copies at requested branch
          $avail = $bm->availableCopies(
              (int)$r['book_id'],
              (int)$r['branch_id']
          );
        ...
        <tr>
          ...
          <td>
            ...
            <form method="POST" class="d-inline-flex gap-1">
              ...
              <!-- Disable approve if stock unavailable -->
              <button name="action"
                      value="approve"
                      class="btn btn-sm btn-success"
                      disabled
